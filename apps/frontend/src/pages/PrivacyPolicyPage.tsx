          ...
          <CardContent className="prose prose-gray max-w-none">
            <div className="space-y-6">
              <section>
                ...
                <p>
                  RestoHand ("we," "our," or "us") is committed to protecting
              ...
              <section>
                ...
                <h3 className="text-xl font-medium mb-2">
                  2.1 Restaurant Business Information
                </h3>
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>
                    Role assignments (owner, manager, chef, waiter, cashier)
                  </li>
                  <li>Login timestamps and activity logs</li>
                </ul>

                <h3 className="text-xl font-medium mb-2">
                  2.3 Customer Information (Optional)
                </h3>
                <ul className="list-disc pl-6 mb-4">
                  <li>
                    Name and phone number (provided voluntarily during order
                    placement)
                  </li>
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>
                    Note: RestoHand never stores credit card or bank account
                    details
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6">
                  <li>
                    Provide restaurant management services and order processing
                  </li>
                  <li>
                    Process payments through Razorpay (with direct settlement to
                    restaurants)
                  </li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6">
                  <li>
                    <strong>Payment Processing:</strong> Order and payment
                    information with Razorpay for transaction processing
                  </li>
                  <li>
                    <strong>Service Providers:</strong> With trusted third-party
                    services for hosting, analytics, and support
                  </li>
                  <li>
              ...
              <section>
                ...
                <ul className="list-disc pl-6">
                  <li>
                    <strong>Restaurant Data:</strong> For the duration of your
                    subscription plus 7 years for tax compliance
                  </li>
                  <li>
                    <strong>Order Records:</strong> 7 years as required by
                    Indian tax laws
                  </li>
                  <li>
                    <strong>Staff Information:</strong> While employed and 3
                    years after termination
                  </li>
                  <li>
                    <strong>Customer Data:</strong> Only during order processing
                    and 30 days for support purposes
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6">
                  <li>
                    <strong>Razorpay:</strong> Payment processing and UPI
                    transactions
                  </li>
                  <li>
                    <strong>Google Firebase:</strong> Authentication and hosting
                    services
                  </li>
                  <li>
                    <strong>MongoDB Atlas:</strong> Database hosting and
                    management
                  </li>
                  <li>
              ...
              <section>
                ...
                <p>
                  RestoHand is intended for business use and is not designed for
