...
| `CLOUD_STORAGE_BUCKET`                | No       | `restohand-development-bucket`                                | Bucket for generated PDFs and assets.                             |
| `CLOUD_STORAGE_BASE_URL`              | No       | `https://storage.googleapis.com/restohand-development-bucket` | Public base URL to access bucket files.                           |
